...
describe("translate", () => {
  ...
  it("keeps catalogs aligned so screens can share one component tree", () => {
    ...
    const requiredKeys: TranslationKey[] = [
      ...
      "masterCv.form.profilePhoto",
      "masterCv.form.profilePhotoHelper",
      "masterCv.form.uploadPhoto",
      "masterCv.form.replacePhoto",
      "masterCv.form.removePhoto",
      "masterCv.form.fullName",
      "masterCv.form.email",
      "masterCv.form.phone",
      "masterCv.form.location",
      "masterCv.form.linkedin",
      "masterCv.form.website",
      "masterCv.form.professionalTitle",
      ...
      "masterCv.validation.photoTooLarge",
