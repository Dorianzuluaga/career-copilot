...
- Regenerate the comparison after updating the Job Analysis or Master CV.
...
If either the Job Analysis or the Master CV changes, the comparison becomes outdated and should be regenerated.
